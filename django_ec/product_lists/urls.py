...
from .views import product_list_view, product_detail_view, product_create_view , product_delete_view, product_edit_view, product_update_view,admin_page,admin_product_list_view
